// SOURCE: https://github.com/JustAlittleWolf/centered-crosshair
// DrawContext extension for sub-pixel positioned crosshair drawing
...
public class DrawContextMixin implements DrawContextFloatDrawTexture {
    ...
    @Shadow @Final GuiRenderState state;
    ...
    public void centered_crosshair$drawGuiTexture(RenderPipeline pipeline, Identifier texture, float x, float y, int width, int height) {
        ...
        this.drawTexturedQuad(
            pipeline, sprite.getAtlasId(),
            x, x + width, y, y + height,
            sprite.getMinU() + (0b1 / 32768f), sprite.getMaxU() + (0b1 / 32768f),
            sprite.getMinV() - (0b1 / 32768f), sprite.getMaxV() - (0b1 / 32768f),
            -1
        );
    }
