// SOURCE: https://github.com/odtheking/Odin/blob/main/odinclient/src/main/kotlin/me/odinclient/features/impl/dungeon/CloseChest.kt
...
object CloseChest : Module(
    ...
    private val mode by SelectorSetting("Mode", "Auto", arrayListOf("Auto", "Any Key"),
        desc = "Auto will automatically close the chest, any key will make any key input close the chest.")

    // Auto mode: intercept S2DPacketOpenWindow for chests, send C0DPacketCloseWindow immediately, cancel the open
    @SubscribeEvent
    ...
    // Any-key mode: close on any key press or mouse click while chest is open
    @SubscribeEvent
