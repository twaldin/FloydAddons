// SOURCE: https://github.com/Noamm9/NoammAddons/blob/master/src/main/kotlin/noammaddons/features/impl/misc/MotionBlur.kt
...
object MotionBlur: Feature("Blurs your screen a little to simulate smoother and cleaner gameplay") {
    ...
    fun renderOverlay(event: RenderOverlayNoCaching) {
        ...
        blurBufferInto?.apply { framebufferClear(); bindFramebuffer(true) }
