// SOURCE: https://github.com/Noamm9/NoammAddons/blob/master/src/main/kotlin/noammaddons/features/impl/misc/PlayerModel.kt
...
object PlayerModel: Feature() {
    ...
    override fun init() = addSettings(
        ...
        playerSpin, spinOnEveryone, spinDirection, spinSpeed,
    )
    ...
    fun onRenderEntityPost(event: RenderPlayerEvent.Post) {
        if ((playerScale.value && (scaleEveryone.value || event.entity == mc.thePlayer)) ||
